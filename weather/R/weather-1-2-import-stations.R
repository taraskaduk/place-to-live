...
saveRDS(stations_to_locs, file = "data/stations-to-locs.RDS")
saveRDS(stations_filtered, file = "data/stations-filtered.RDS")
saveRDS(locations_filtered, file = "data/locations-filtered.RDS")
